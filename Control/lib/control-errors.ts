...
const userMessagesByCode: Record<string, string> = {
  ...
  PAYMENT_METHOD_DISABLED: 'Ce mode de paiement est desactive dans les reglages caisse.',
  ...
  SHOP_CLOSING_TIME_INVALID: 'Renseigne une heure de cloture valide.',
  SHOP_CURRENCY_INVALID: 'Selectionne une devise valide.',
  SHOP_DEFAULT_UNIT_INVALID: 'Selectionne une unite valide.',
  SHOP_DISPLAY_PREFERENCE_INVALID: 'Selectionne une preference valide.',
  SHOP_LANGUAGE_INVALID: 'Selectionne une langue valide.',
  SHOP_LOW_STOCK_THRESHOLD_INVALID: 'Renseigne un seuil de stock valide.',
  SHOP_PAYMENT_METHOD_INVALID: 'Selectionne des modes de paiement valides.',
  ...
  TEAM_CODE_EXPIRED: 'Ce code d’invitation a expiré.',
